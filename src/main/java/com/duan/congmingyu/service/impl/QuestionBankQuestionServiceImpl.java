...
import com.duan.congmingyu.mapper.QuestionBankQuestionMapper;
import com.duan.congmingyu.model.dto.questionBankQuestion.QuestionBankQuestionQueryRequest;
import com.duan.congmingyu.model.entity.Question;
import com.duan.congmingyu.model.entity.QuestionBank;
import com.duan.congmingyu.model.entity.QuestionBankQuestion;
import com.duan.congmingyu.model.entity.User;
import com.duan.congmingyu.model.vo.QuestionBankQuestionVO;
import com.duan.congmingyu.model.vo.UserVO;
import com.duan.congmingyu.service.QuestionBankQuestionService;
import com.duan.congmingyu.service.QuestionBankService;
import com.duan.congmingyu.service.QuestionService;
...
//        }
    ...
    public void batchAddQuestionsToBank(List<Long> questionIdList, long questionBankId, User loginUser) {
        ...
        ThrowUtils.throwIf(CollUtil.isEmpty(validQuestionIdList), ErrorCode.PARAMS_ERROR, "所有题目都以经存在于题库中");
        // 检查题库 id 是否存在
        QuestionBank questionBank = questionBankService.getById(questionBankId);
        ThrowUtils.throwIf(questionBank == null, ErrorCode.NOT_FOUND_ERROR, "题库不存在");
        // 自定义线程池 (IO密集型线程池)
        ...
        int batchSize = 1000;
        int totalQusetionListSize = validQuestionIdList.size();
        for (int i = 0; i < totalQusetionListSize; i += batchSize) {
            //生成每批次的数据
            List<Long> subList = validQuestionIdList.subList(i, Math.min(i + batchSize, totalQusetionListSize));
